...
const schemaMarkup = {
  ...
  '@graph': [
    ...
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        { '@type': 'Question', name: 'How much does it cost to get a website built?', acceptedAnswer: { '@type': 'Answer', text: 'Costs depend on scope. Simple company websites start from €1,500, complex platforms and online shops from €3,000.' } },
