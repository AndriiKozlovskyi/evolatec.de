  ...
  <div class="bg-surface-container-low">
    ...
    <div class="max-w-3xl mx-auto px-gutter pb-16 md:pb-24 -mt-10">
      <article class="bg-white rounded-2xl border border-outline-variant/20 shadow-sm p-6 sm:p-10">
        ...
        <p class="legal-p">The processing of this data is based on Art. 6(1)(b) GDPR (initiation of contract) and Art. 6(1)(f) GDPR. The data will be deleted once your enquiry has been fully processed and there are no statutory retention obligations.</p>
