        ...
        <div class="grid md:grid-cols-3 gap-5">
          <div class="bg-white rounded-2xl p-7 border border-outline-variant/30 flex flex-col">
            ...
            <ul class="space-y-2.5 text-sm text-on-surface-variant flex-1">
              ...
              <li class="flex gap-2 items-start"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-base flex-shrink-0 mt-0.5">check_circle</span>Kurze Time-to-Market</li>
              <li class="flex gap-2 items-start"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-base flex-shrink-0 mt-0.5">check_circle</span>Maximale Conversion-Rate</li>
            </ul>
          ...
          <div class="bg-primary rounded-2xl p-7 flex flex-col shadow-xl">
            ...
            <ul class="space-y-2.5 text-sm text-on-primary-container flex-1">
              <li class="flex gap-2 items-start"><span translate="no" class="notranslate material-symbols-outlined text-white text-base flex-shrink-0 mt-0.5">check_circle</span>Unternehmensdarstellung</li>
              <li class="flex gap-2 items-start"><span translate="no" class="notranslate material-symbols-outlined text-white text-base flex-shrink-0 mt-0.5">check_circle</span>Langfristige SEO-Sichtbarkeit</li>
              <li class="flex gap-2 items-start"><span translate="no" class="notranslate material-symbols-outlined text-white text-base flex-shrink-0 mt-0.5">check_circle</span>Mehrere Seiten & CMS-Pflege</li>
            </ul>
          ...
          <div class="bg-white rounded-2xl p-7 border border-outline-variant/30 flex flex-col">
            ...
            <ul class="space-y-2.5 text-sm text-on-surface-variant flex-1">
              <li class="flex gap-2 items-start"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-base flex-shrink-0 mt-0.5">check_circle</span>Produktverwaltung & Varianten</li>
              <li class="flex gap-2 items-start"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-base flex-shrink-0 mt-0.5">check_circle</span>Sichere Zahlungsabwicklung</li>
              <li class="flex gap-2 items-start"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-base flex-shrink-0 mt-0.5">check_circle</span>Shopify oder Custom-Lösung</li>
            </ul>
            <div class="mt-6 pt-4 border-t border-outline-variant/20 flex items-center justify-between">
          ...
          <div v-for="(row, i) in inclusiveTable" :key="i" class="bg-white rounded-xl border border-outline-variant/30 p-4">
            ...
            <div class="grid grid-cols-3 gap-2">
              <div class="bg-surface-container-low rounded-lg p-2.5 text-center">
                ...
                <template v-if="row.landing === true"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-base">check_circle</span></template>
                <template v-else-if="row.landing === false"><span translate="no" class="notranslate material-symbols-outlined text-on-surface-variant/40 text-base">remove</span></template>
              ...
              <div class="bg-primary/5 rounded-lg p-2.5 text-center border border-primary/15">
                ...
                <template v-if="row.firma === true"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-base">check_circle</span></template>
                <template v-else-if="row.firma === false"><span translate="no" class="notranslate material-symbols-outlined text-on-surface-variant/40 text-base">remove</span></template>
              ...
              <div class="bg-surface-container-low rounded-lg p-2.5 text-center">
                ...
                <template v-if="row.shop === true"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-base">check_circle</span></template>
                <template v-else-if="row.shop === false"><span translate="no" class="notranslate material-symbols-outlined text-on-surface-variant/40 text-base">remove</span></template>
            ...
            <tbody>
              <tr v-for="(row, i) in inclusiveTable" :key="i" :class="i % 2 === 0 ? 'bg-white' : 'bg-surface-container-low/40'">
                ...
                <td class="p-4 text-center">
                  <template v-if="row.landing === true"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-lg" aria-label="inklusive">check_circle</span></template>
                  <template v-else-if="row.landing === false"><span translate="no" class="notranslate material-symbols-outlined text-on-surface-variant/40 text-lg" aria-label="nicht inklusive">remove</span></template>
                ...
                <td class="p-4 text-center bg-primary/5">
                  <template v-if="row.firma === true"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-lg" aria-label="inklusive">check_circle</span></template>
                  <template v-else-if="row.firma === false"><span translate="no" class="notranslate material-symbols-outlined text-on-surface-variant/40 text-lg" aria-label="nicht inklusive">remove</span></template>
                  <template v-else><span class="text-primary font-semibold text-xs">{{ row.firma }}</span></template>
                </td>
                <td class="p-4 text-center">
                  <template v-if="row.shop === true"><span translate="no" class="notranslate material-symbols-outlined text-emerald-500 text-lg" aria-label="inklusive">check_circle</span></template>
                  <template v-else-if="row.shop === false"><span translate="no" class="notranslate material-symbols-outlined text-on-surface-variant/40 text-lg" aria-label="nicht inklusive">remove</span></template>
