  ...
  <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-stack-lg">
          ...
          <div class="lg:col-span-1">
            <div class="space-y-stack-md">
              <!-- Email -->
              <div class="group">
                <h3 class="text-headline-md font-bold text-on-surface mb-4 flex items-center gap-3">
                  <span class="material-symbols-outlined text-2xl text-primary">mail</span>
                  E-Mail
                </h3>
                <a
                  href="mailto:team@evolatec.de"
                  class="text-body-md text-on-surface-variant hover:text-primary transition-colors duration-200"
                >
                  team@evolatec.de
                </a>
              </div>
              ...
              <div class="group">
                <h3 class="text-headline-md font-bold text-on-surface mb-4 flex items-center gap-3">
                  <span class="material-symbols-outlined text-2xl text-primary">phone</span>
                  Telefon
                </h3>
                <a
              ...
              <div class="mt-8 p-6 bg-primary/5 rounded-xl border border-primary/10">
                <div class="flex items-center gap-3 mb-2">
                  ...
                  <h4 class="font-bold text-on-surface">Antwortzeit</h4>
                </div>
                <p class="text-body-md text-on-surface-variant">
          ...
          <div class="lg:col-span-2">
            <div class="bg-surface-container-low rounded-2xl p-12">
              <h2 class="text-headline-lg font-bold text-on-surface mb-2">Schreiben Sie uns</h2>
              <p class="text-on-surface-variant mb-stack-lg">
    ...
    <section class="py-section-padding bg-gradient-to-r from-primary/90 via-primary to-primary/90 text-on-primary relative overflow-hidden">
      ...
      <div class="relative z-10 max-w-container-max mx-auto px-gutter">
        <h2 class="font-display text-[2.5rem] md:text-[3rem] text-center mb-stack-lg">Warum mit EvolaTec arbeiten?</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div v-for="(benefit, index) in benefits" :key="index" class="text-center animate-fade-in-up" :style="{ animationDelay: `${index * 100}ms` }">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-on-primary-container/20 mb-6">
              <span class="material-symbols-outlined text-2xl">{{ benefit.icon }}</span>
            </div>
            <h3 class="text-headline-md font-bold mb-3">{{ benefit.title }}</h3>
            <p class="text-on-primary-container leading-relaxed">{{ benefit.description }}</p>
          </div>
        </div>
      </div>
    </section>
