<template>
  <div>
    <HeroSection
      background-image="https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=1200&h=600&fit=crop"
    ...
    <FeaturesSection
      ...
      :features="features"
      image-url="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=400&fit=crop"
    />
...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://evolatec.de/seo-optimization' },
  ],
});
...
const optimizationPricingPlans = [
  ...
  },
  {
    ...
    price: 'ab 500 €',
    features: ['Vollständige Tech-Optimierung', 'Core Web Vitals Fixes', 'Struktur-Verbesserung', 'Implementierungsplan'],
  ...
  },
  {
    ...
    price: 'ab 1.200 €',
    features: ['Alle Optimierungen', 'Performance + SEO', 'Sicherheit & Struktur', 'Monitoring & Support'],
