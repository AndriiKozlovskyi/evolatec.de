<template>
  <div>
    ...
    <PricingTableSection
      title="Preise für Social Media Marketing"
      description="Transparente Preise für Social Media Betreuung, Meta Ads und Performance Kampagnen."
...
const schemaMarkup = buildSchema(
  ...
  breadcrumbSchema([
    ...
    { name: 'Online Marketing', url: 'https://evolatec.de/online-marketing' },
    { name: 'Social Media Marketing', url: 'https://evolatec.de/marketing-social-media' },
  ]),
  faqSchema(socialFaqs),
);
