...
const singlePrices = [
  {
    ...
    rows: [
      ...
      { name: 'Premium E-Commerce',   price: 'ab €6.000' },
    ],
  },
  {
    title: 'SEO',
    ...
    rows: [
      ...
      { name: 'SEO Betreuung',              price: 'ab €300 / Mo' },
      { name: 'Local SEO Betreuung',        price: 'ab €300 / Mo' },
      { name: 'Linkbuilding Betreuung',     price: 'ab €700 / Mo' },
    ],
  },
  {
    title: 'Marketing',
    ...
    rows: [
      { name: 'Marketing Beratung',     price: 'ab €90 / Std.' },
      ...
      { name: 'Monatliches Reporting',  price: 'ab €100 / Mo'  },
    ],
  },
  {
    ...
    rows: [
      ...
      { name: 'Rebranding & Relaunch',    price: 'ab €2.000'     },
      ...
      { name: 'Landingpage Copywriting',  price: 'ab €250'       },
      { name: 'Komplette Website Inhalte', price: 'ab €700'      },
    ],
  },
];
</script>
