...
const channels = [
  { label: 'E-Mail',   icon: 'mail',  href: 'mailto:team@evolatec.de',          color: '#EA4335' },
  { label: 'WhatsApp', svg: WhatsAppIcon, href: 'https://wa.me/491756200862',   external: true },
  { label: 'Anrufen',  icon: 'phone', href: 'tel:+491756200862',                color: '#002c50' },
